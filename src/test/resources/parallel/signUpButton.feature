...
Feature: As a non-registered user, I should be able to register to the website
  ...
  Scenario: Sign Up to the website by providing required info properly in correct format
    ...
    When  I pass this information
      ...
      | James      | Temple    | JamTT@gmail.com | ohch4vaep9O |
  ...
  Scenario: Sign Up to the website by providing First and Last Name in lowercase
    ...
    When  I pass this information
      | First Name | Last Name | Email Address     | Password   |
      | john       | doe       | jodioee@gmail.com | cei1Michoh |
    And   I click on Sign Up Button
  ...
  Scenario:
    When I enter following information on required field on sign up
      ...
      | Holmes     | Hulme     | hhulmeee2nyrecht24.de | t22UNy3  |
  ...
  Scenario Outline:
    ...
    Examples:
      | FIRST NAME | LAST NAME | EMAIL                       | PASSWORD     |
      | Hanson     | Luck      | hluckk@bing.com             | DZXk23iT     |
      | Patsy      | Ucchino   | pucchinoo@redcross.org      | Bel1iThZ     |
      | Jill       | Stiegers  | jstiegerss@fc2.com          | 0iB4hHI      |
      | Rourke     | Lukacs    | rlukacss@comsenz.com        | Ry9Pdb2g0    |
      | Candra     | Hargreave | chargreavee@marketwatch.com | DQapoG1      |
      | Deni       | Freear    | dfreearr@kickstarter.com    | lb4QISgZ     |
      | Waldon     | Andriuzzi | wandriuzzii@icq.com         | DseGhJY365ae |
      | Kelbee     | Barz      | kbarzz@instagram.com        | nZbVAu       |
      | Matthus    | Boldra    | mboldraa@hibu.com           | QRmoV3M      |
      | Merell     | Lohmeyer  | mlohmeyeraa@dropbox.com     | Ts2iJiEc     |
