...
Feature: As a non-registered user, I should be able to register to the website
  ...
  Scenario Outline:
    ...
    Examples:
      | FIRST NAME | LAST NAME | EMAIL                        | PASSWORD     |
      | Hanson     | Luck      | hluck31@bing.com             | DZXk23iT     |
      | Patsy      | Ucchino   | pucchino32@redcross.org      | Bel1iThZ     |
      | Jill       | Stiegers  | jstiegers33@fc2.com          | 0iB4hHI      |
      | Rourke     | Lukacs    | rlukacs34@comsenz.com        | Ry9Pdb2g0    |
      | Candra     | Hargreave | chargreave35@marketwatch.com | DQapoG1      |
      | Deni       | Freear    | dfreear36@kickstarter.com    | lb4QISgZ     |
      | Waldon     | Andriuzzi | wandriuzzi37@icq.com         | DseGhJY365ae |
